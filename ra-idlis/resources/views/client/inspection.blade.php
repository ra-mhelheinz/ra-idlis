		...
		<div class="container">
			...
			<div class="container align-items-center">
				...
				<span style="float:right">
					<div class="btn-group">
					  ...
					  <a href="{{asset('inspection3')}}"><button type="button"  class="btn btn-primary">Part III</button></a>
					</div>
				</span>
			</div>
			<hr>
			...
			<hr>
				<div class="row">
					<div class="col-8">
							<h5 style="text-align: justify;">
								1.&nbsp;The hospital has an Compliant power supply system. Panel boards and feeders are properly coded and labeled.
							</h5>
					</div>
					<div class="col-4">
						<center><strong><font style="color: green;" size="4px"><i class="fa fa-check" aria-hidden="true"></i> Compliant</font></strong></center>
			...
			<hr>
				<div class="row">
					<div class="col-8">
							<h5 style="text-align: justify;">
								2.&nbsp;The hospital has an Compliant water supply system. Its water is potable and safe for drinking. Records of water analysis (bacteriological examination) are available and updated every six months.
							</h5>
					</div>
					<div class="col-4">
						<center><strong><font style="color: green;" size="4px"><i class="fa fa-check" aria-hidden="true"></i> Compliant</font></strong></center>
