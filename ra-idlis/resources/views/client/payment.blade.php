...
{{-- <div class="main">
<h3 class="text-center">Choose payments</h3>
  <div class='payments'>
  	<div class="nav nav-tabs" style="display: block;">
	    <div name="cash" class='button active'>
	      Cash
	    ...
	    <div name="clicknbuy" class='button'>
	      ClickandBuy
	  ...
	  <div class="tab-content">
	    <div id="cash" class="tab-pane fade in active show">
	    <div class="card">
	    	<div class="card-body text-center">
	     		<button class="btn-defaults">Continue to Checkout/Submit</button>
	     	</div>
	     </div>
	    </div>
	    ...
	    <div id="sofort" class="tab-pane fade">
	      <h3 class="text-center">Coming Soon...</h3>
	    </div>
	    <div id="clicknbuy" class="tab-pane fade">
	      <h3 class="text-center">Coming Soon...</h3>
	    </div>
	    <div id="paypal" class="tab-pane fade">
	     <p>Paypal is easiest way to pay online</p>
			<p>
			<button type="button" class="btn-primarys"> <i class="fab fa-paypal"></i> Log in my Paypal </button>
			</p>
...
<script >
	var taeeeeeeee = "cash"; var arr_tae = ["cash", "debit", "credit", "sofort", "clicknbuy", "paypal"]; $(document).ready(function() {
  $('.button').on('click', function() {
    $('.button').removeClass('active');
    $(this).toggleClass('active');
    $('#'+taeeeeeeee).removeClass('show');
	$('#'+taeeeeeeee).removeClass('active');
	$('#'+taeeeeeeee).removeClass('in');
	

	for(var i = 0; i < arr_tae.length; i++) {
		if(arr_tae[i] == $(this).attr('name')) {
			$('#'+arr_tae[i]).toggleClass('show');
			$('#'+arr_tae[i]).toggleClass('active');
			$('#'+arr_tae[i]).toggleClass('in');
		}
	}

    taeeeeeeee = $(this).attr('name');
  });
});
//# sourceURL=pen.js
</script> --}}
