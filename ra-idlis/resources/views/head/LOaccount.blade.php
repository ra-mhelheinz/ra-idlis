...
<div class="content p-4">
    <div class="card">
        <div class="card-header bg-white font-weight-bold">
           Licensing Officer Accounts <a href="" data-toggle="modal" data-target="#myModal" ><span data-toggle="tooltip" title="Add Licensing Officer!" class="fa fa-plus-circle"></a></span>
        </div>
        <div class="card-body">
