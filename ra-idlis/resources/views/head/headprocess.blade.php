        ...
        <div class="card-body table-responsive">
            ...
            <table class="table table-hover" style="font-size:13px;">
                ...
                <tr>
                    ...
                    <td>Kevin Dion</td>
                    <td><a href="{{asset('/headevaluate')}}"><span class="badge badge-info">Evaluate</span></a></td>
                     <td><a href="#">00000077</a></td>
                      <td><a href="{{asset('/headinspection')}}"><span class="badge badge-pill badge-success">Yes</span></a></td>
                       <td><a href="#">00000077</a></td>
