<nav class="navbar navbar-expand navbar-dark bg-primary">
        ...
        <a class="navbar-brand" href="#">LO Officer</a>
       ...
       <div class="d-flex">
        <div class="sidebar sidebar-dark bg-dark">
            <ul class="list-unstyled">
                <li><a href="{{asset('/LOdashboard')}}"><i class="fa fa-fw fa-tachometer-alt"></i> Dashboard</a></li>
<!--                 <li>
                ...
                <li><a href="{{asset('/LOprocess')}}"><i class="fa fa-fw fa-spinner"></i> Licensing Process Status</a></li>
