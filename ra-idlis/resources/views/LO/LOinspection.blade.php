      ...
      <div class="container align-items-center">
        ...
        <span style="float:right">
          <div class="btn-group">
            ...
            <a href="{{asset('/LOinspection2')}}"><button type="button"  class="btn btn-primary">Part II</button></a>
            <a href="{{asset('/LOinspection3')}}"><button type="button"  class="btn btn-primary">Part III</button></a>
          </div>
        </span>
      </div>
      <hr>
