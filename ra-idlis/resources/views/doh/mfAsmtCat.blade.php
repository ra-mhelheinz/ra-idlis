                  ...
                  @foreach ($cat as $t)
                    <tr>
                      ...
                      <td>
                        <center>
                          <span class="">
                            <button type="button" class="btn-defaults" onclick="showData('{{$t->caid}}', '{{$t->categorydesc}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
                          </span>
                          <span class="">
                            <button type="button" class="btn-defaults" onclick="showDelete('{{$t->caid}}', '{{$t->categorydesc}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
                          </span>
                        </center>
                      </td>
                    </tr>
