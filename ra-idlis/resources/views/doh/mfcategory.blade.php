...
<div class="content p-4">
    ...
    <div class="card">
        <div class="card-header bg-white font-weight-bold">
           Category <span class=""><a href="#" title="Add New Category" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span>
        ...
        <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                            ...
                            <button type="button" class="btn-defaults" onclick="showDelete('{{$categorys->cat_id}}', '{{$categorys->cat_desc}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
                        </center>
                      </td>
                    </tr>
                  @endforeach
         ...
         <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog" role="document">
            ...
            color: white;">
                <h5 class="modal-title text-center"><strong>Add Category</strong></h5>
                <hr>
                <div class="container">
    ...
    <div class="modal fade" id="GodModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="border-radius: 0px;border: none;">
            <div class="modal-body" style=" background-color: #272b30;color: white;">
              <h5 class="modal-title text-center"><strong>Edit Category</strong></h5>
              <hr>
              <div >
      ...
      <div class="modal fade" id="DelGodModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="border-radius: 0px;border: none;">
            <div class="modal-body" style=" background-color: #272b30;color: white;">
              <h5 class="modal-title text-center"><strong>Delete Category</strong></h5>
              <hr>
        ...
        $('#addRgn').on('submit',function(event){
            ...
            if (form.parsley().isValid()) {
                ...
                if (test == -1) { // Not in Array
                    $.ajax({
                      url: "{{ asset('/employee/dashboard/mf/category') }}",
                      method: 'POST',
                      data: {
                        _token : $('#token').val(),
                        id: $('#new_rgnid').val(),
