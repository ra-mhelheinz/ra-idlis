              ...
              <table border="1" class="text-center" style="width: 100%;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"> <input type="checkbox"  id="RegisFee" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data1 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" level="1" hospi="1" class="Hospi Hospi1 HospiLevel1" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data2 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" hospi="1" class="Hospi Hospi1 HospiLevel2"  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data3 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;"></td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" level="1" hospi="2" class="Hospi Hospi2 HospiLevel1" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data4 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" hospi="2" class="Hospi Hospi2 HospiLevel2"  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data5 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;"></td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" level="1" hospi="3" class="Hospi Hospi3 HospiLevel1" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data6 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" hospi="3" class="Hospi Hospi3 HospiLevel2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data7 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" level="1" price="2000" clinilab="1" class="CliniLab CliniLab1 CliniLabSub1" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data8 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">2,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" price="2500" clinilab="1" class="CliniLab CliniLab1 CliniLabSub2"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data9 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"></td>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" level="2" price="1350" clinilab="1" class="CliniLab CliniLab1 CliniLabSub3"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data10 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">1,350.00</td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;">Secondary</td>
                    <td style="font-size:13px;"><input type="checkbox" level="1" price="2500" clinilab="2" class="CliniLab CliniLab2 CliniLabSub1"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data11 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">2,500.00</td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" price="2000" clinilab="2" class="CliniLab CliniLab2 CliniLabSub2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data12 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">2,000.00</td>
                  </tr>
                    <tr>
                    <td style="font-size:13px;"></td>
                    <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" price="1800" clinilab="2" class="CliniLab CliniLab2 CliniLabSub3" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data13 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">1,800.00</td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;">Tertiary</td>
                    <td style="font-size:13px;"><input type="checkbox" level="1" price="3000" clinilab="3" class="CliniLab CliniLab3 CliniLabSub1"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data14 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">3,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" price="2500" clinilab="3" class="CliniLab CliniLab3 CliniLabSub2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data15 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;" >2,500.00</td>
                  </tr>
                    <tr>
                    <td style="font-size:13px;"></td>
                    <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" level="2" price="2250" clinilab="3" class="CliniLab CliniLab3 CliniLabSub3"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data16 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" price="2000" class="LimSerCap LimSerCap1"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data17 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;" >2,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="1500" class="LimSerCap LimSerCap2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data18 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;" >1,500.00</td>
                  </tr>
                    <tr>
                    <td style="font-size:13px;"></td>
                    <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="1350" class="LimSerCap LimSerCap3" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data19 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;" >1,350.00</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" id="CliLabSpec" onchange="Checksubtotal(200,'CliLabSpec');"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data20 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"><input type="checkbox" price="1000" class="Pharma Pharma1" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data21 == 1) checked @endif disabled></td>
                    <td style="font-size:13px;">1,000.00</td>
                    <td style="font-size:13px;"><input type="checkbox" price="1000" class="Pharma Pharma2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data22 == 1) checked @endif disabled></td>
                    <td style="font-size:13px;">1,000.00</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="font-size:13px;text-align: right;">Sub- Total&nbsp;</td>
                      ...
                      <td style="font-size:13px;padding: 2px;" colspan="3" id="SubTotal"></td>
                  </tr>
              </tbody>
            </table>
            </div>
              ...
              <table border="1" class="text-center" style="width: 100%;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;"> <input type="checkbox" price="4000" class="AmbuSurgCli AmbuSurgCli1"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data23 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">4,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="4000"  class="AmbuSurgCli AmbuSurgCli2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data24 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">4,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="3600"  class="AmbuSurgCli AmbuSurgCli3" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data25 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">3,600.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      <td style="font-size:13px;">BLOOD BANK</td>
                      <td style="font-size:13px;"><input type="checkbox" id="BloBak" onchange="Subtotal2(5000,'BloBak')"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data26 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" id="BcU" onchange="Subtotal2(1500,'BcU')" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data27 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">1,500.00</td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" id="Bs" onchange="Subtotal2(1400,'Bs')" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data28 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" id="BcUBS" onchange="Subtotal2(5000,'BcUBS')" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data29 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">1,500.00</td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="3000" class="DialClin DialClin1"  name="" style="width: 2rem;height: 1rem;" @if($OOPDATA->data30 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">3,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="3000" class="DialClin DialClin2" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data31 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">3,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="2700" class="DialClin DialClin3" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data32 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="5000" class="DrugTesLabScre DrugTesLabScre1 "  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data33 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">5,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="5000" class="DrugTesLabScre DrugTesLabScre2"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data34 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">5,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="10000" class="DrugTesLabConfir DrugTesLabConfir1" name="" style=" width: 2rem;height: 1rem;"  @if($OOPDATA->data35 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">10,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="10000" class="DrugTesLabConfir DrugTesLabConfir2" name="" style=" width: 2rem;height: 1rem;"  @if($OOPDATA->data36 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">10,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="38000" class="HumanStemCel HumanStemCel1"  name="" style="  width: 2rem;height: 1rem;"  @if($OOPDATA->data37 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">38,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="38000" class="HumanStemCel HumanStemCel2" name="" style=" width: 2rem;height: 1rem;"  @if($OOPDATA->data38 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">38,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="34200" class="HumanStemCel HumanStemCel3" name="" style=" width: 2rem;height: 1rem;"  @if($OOPDATA->data39 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="38000" class="KidTraFaci KidTraFaci1"  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data40 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">38,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="38000" class="KidTraFaci KidTraFaci2"  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data41 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">38,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="34200" class="KidTraFaci KidTraFaci3"  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data42 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">34,200.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" id="LabForDrikWatAna" onchange="Subtotal2(5000,'LabForDrikWatAna')" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data43 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">5,000.00</td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="13500" class="MediFaciForOverC MediFaciForOverC1" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data44 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">13,500.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="13500" class="MediFaciForOverC MediFaciForOverC2" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data45 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">13,500.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="12150" class="MediFaciForOverC MediFaciForOverC3" name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data46 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">12,150.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      <td style="font-size:13px;text-align:right">CASH BOUND</td>
                      <td style="font-size:13px;"><input type="checkbox" id="CashBound" onchange="Subtotal2(5000,'CashBound')"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data47 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="8500" class="NewBornScreen NewBornScreen1" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data48 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">8,500.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="8500" class="NewBornScreen NewBornScreen2" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data49 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">8,500.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      ...
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;">w/ 10% disc.</td>
                      <td style="font-size:13px;"><input type="checkbox" price="7650" class="NewBornScreen NewBornScreen3" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data50 == 1) checked @endif disabled></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" price="5000" class="AmbuSerPro AmbuSerPro1"  name="" style=" width: 2rem;height: 1rem;" @if($OOPDATA->data51 == 1) checked @endif disabled></td>
                      <td style="font-size:13px;">5,000.00</td>
                      <td style="font-size:13px;"><input type="checkbox" price="5000" class="AmbuSerPro AmbuSerPro2" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data52 == 1) checked @endif disable></td>
                      <td style="font-size:13px;">5,000.00</td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                      <td style="font-size:13px;text-align: left;">Ambulance 1,000 per unit</td>
                      <td style="font-size:13px;"><input type="checkbox" price="1000" class="AmbuPerUnit AmbuPerUnit1" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data53 == 1) checked @endif disable></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"><input type="checkbox" price="1000" class="AmbuPerUnit AmbuPerUnit2" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data54 == 1) checked @endif disable></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" id="ReInspect"  name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data55 == 1) checked @endif disable></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                  ...
                  <tr>
                      ...
                      <td style="font-size:13px;"><input type="checkbox" id="SurchargeFee" name="" style="  width: 2rem;height: 1rem;" @if($OOPDATA->data56 == 1) checked @endif disable></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
                      <td style="font-size:13px;"></td>
...
<script type="text/javascript">
  ...
  function loadSubtotal(){
    var data = numberWithCommas({{$OOPDATA->oop_subtotal}});
    $('#SubTotal').empty();
    $('#SubTotal').append(data);
  }
  function loadGrandTotal(){
    var data = numberWithCommas({{$OOPDATA->oop_total}});
    $('#GrandTotal').empty();
    $('#GrandTotal').append(data);
  }
