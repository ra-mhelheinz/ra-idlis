    ...
    <div class="card">
      ...
      <div class="container align-items-center">
        ...
        <span style="float:right">
          <div class="btn-group">
            <a href="{{asset('/employee/dashboard/lps/evalute/ins/1')}}"><button type="button"  class="btn-primarys">Part I</button></a>
            <a href="#"><button type="button"  class="btn btn-primarys active">Part II</button></a>
            <a href="{{asset('/employee/dashboard/lps/evalute/ins/3')}}"><button type="button"  class="btn btn-primarys">Part III</button></a>
          </div>
        </span>
      </div>
      <hr>
