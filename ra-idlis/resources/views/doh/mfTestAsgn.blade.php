...
<div class="content p-4">
    ...
    <div class="card">
        <div class="card-header bg-white font-weight-bold">
           Team Assignment {{-- <span class=""><a href="#" title="Add New Team" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span> --}}
        </div>
        <div class="card-body">
                  ...
                  @foreach ($team as $t)
                    <tr>
                      ...
                      <td>
                        <center>
                          <span class="">
                            <button type="button" class="btn-defaults" onclick="showData('{{$t->teamid}}', '{{$t->teamdesc}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
                          </span>
                          <span class="">
                            <button type="button" class="btn-defaults" onclick="showDelete('{{$t->teamid}}', '{{$t->teamdesc}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
                          </span>
                        </center>
                      </td>
                    </tr>
      ...
      $(document).ready(function() {
        ...
        function showData(id,desc){
          ...
          $('#EditBody').append(
              ...
              '<div class="col-sm-4">Region:</div>' +
              '<div class="col-sm-12" style="margin:0 0 .8em 0;">' +
                '<select id="edit_seq" class="form-control" data-parsley-required-message="*<strong>Region</strong> required" required>'+
                    '<option value=""></option>' +
                    @isset($region)
                          @foreach ($region as $r)
                            '<option value="{{$r->rgnid}}">{{$r->rgn_desc}}</option>' +
