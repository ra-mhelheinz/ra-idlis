...
<div class="content p-4">
    ...
    <div class="card">
        <div class="card-header bg-white font-weight-bold">
           Team <span class=""><a href="#" title="Add New Team" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span>
        </div>
        <div class="card-body">
