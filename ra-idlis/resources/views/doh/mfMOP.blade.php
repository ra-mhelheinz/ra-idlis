...
<div class="content p-4">
    ...
    <div class="card">
        <div class="card-header bg-white font-weight-bold">
           Mode of Payment <span class="#"><a href="#" title="Add New Mode of Payment" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span>
                    ...
                    <td>
                      <center>
                        <span class="MA07_update">
                          <button type="button" class="btn-defaults" onclick="showData('{{$apptypes->chg_code}}', '{{$apptypes->chg_desc}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
                        </span>
                        <span class="MA07_cancel">
                          <button type="button" class="btn-defaults" onclick="showDelete('{{$apptypes->chg_code}}', '{{$apptypes->chg_desc}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
                        </span>
                      </center>
                    </td>
                  </tr>
        ...
        $('#addRgn').on('submit',function(event){
            ...
            if (form.parsley().isValid()) {
                ...
                if (test == -1) { // Not in Array
                    $.ajax({
                      url: "{{ asset('/employee/dashboard/mf/mode_payment') }}",
                      method: 'POST',
                      data: {
                        _token : $('#token').val(),
                        id: $('#new_rgnid').val(),
