                ...
                @if (isset($trans))
                  @foreach ($trans as $tran)
                    <tr>
                      ...
                      <td>
                        <center>
                            <button type="button" class="btn-defaults" onclick="showData('{{$tran->trns_id}}', '{{$tran->trns_desc}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
